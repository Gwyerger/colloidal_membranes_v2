...
pathexp = '/home/gabriel/Repositories/colloidal_membranes_v2/data_viz/extracted_data/single_pore_ellipse/FinalSnapshot'
...
for s in ss:
    for f in fs:
        for q in qs:
            ...
            DataSet = LegacyVTKReader(registrationName='SinglePore.vtk*', FileNames=[pathc+f'/SinglePoreq={qq}s={s}.vtk'])
            ...
            # save screenshot
            SaveScreenshot(pathexp+f"/SinglePoreq={qq}s={s}.png", renderView1, ImageResolution=[1952, 650])
